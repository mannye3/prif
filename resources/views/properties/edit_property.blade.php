                                ...
                                <div class="nk-block-head nk-block-head-sm">
                                    <div class="nk-block-between">
                                        <div class="nk-block-head-content">
                                            <h3 class="nk-block-title page-title">{{$ride->name}}</h3>
                                ...
                                <div class="nk-block">
                                    <div class="card card-bordered card-stretch">
                                        <div class="card-inner">
                                              <form  method="POST" action="{{ route('property_update', $ride->id)}}" enctype="multipart/form-data">
                                                    @csrf
                                            ...
                                            <div class="row gy-4 pt-3">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="d-flex gx-3">
                                                                <div class="g w-100">
                                                                    <div class="form-control-wrap">
                                                                          <input type="text" class="form-control" placeholder="e.g. Honda" name="name" value="{{$ride->name}}" required>
                                                                    </div>
                                                                </div>
                                               ...
                                               <div class="col-lg-3 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="number" value="{{$ride->price}}" name="price" class="form-control" id="price" placeholder="e.g. $100.00" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                             <select class="form-control" required name="property_cat"> 
                                                                <option value="{{$ride->property_cat}}">{{$ride->property_cat}}</option> 
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select class="form-control" required name="property_type"> 
                                                                <option value="{{$ride->property_type}}">{{{$ride->property_type}}}</option> 
                                                ...
                                                <div class="col-lg-3 col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <option value="{{$ride->property_bed}}">{{{$ride->property_bed}}}</option> 
                                            ...
                                            <div class="row gy-4 pt-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <div class="custom-file">
                                                            <input type="text" value="{{$ride->property_location}}" name="property_location" class="form-control">
                                                ...
                                                <div class="col-md-6">
                                                     @if(!empty($ride->property_picture)) 
                                                       <img  height="150" width="100" src="{{ asset('/properties/' . $ride->property_picture) }}" />
                                                            @endif
                                                <div class="form-group">
                                                ...
                                                <div class="col-lg-12 col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <textarea name="property_desc" class="summernote-minimal">{{$ride->property_desc}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
