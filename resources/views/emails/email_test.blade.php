            ...
            <td align="center" class="sm-p-20 sm-dui17-b-t" style="border-radius: 2px; padding: 40px;  box-shadow: 0 10px 15px -3px rgba(0, 0, 0, .1), 0 4px 6px -2px rgba(0, 0, 0, .05); vertical-align: top; z-index: 50;" bgcolor="#ffffff" valign="top">
              ...
              <table style="font-size: 14px;" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                <tr>
                  ...
                  <td class="sm-w-full sm-inline-block sm-py-12" style="font-family: Menlo, Consolas, monospace; font-weight: 600; text-align: center; color: #000000; font-size: 18px; letter-spacing: -1px;" width="20%" align="center">&gt;&gt;&gt;</td>
                  <td class="sm-w-full sm-inline-block sm-text-center" style="text-align: right;" width="40%" align="right">
                    <p class="all-font-roboto" style="margin: 0; margin-bottom: 4px; color: #000000; font-size: 15px; text-transform: uppercase; letter-spacing: 1px;">Drop-Off</p>
                    <p class="all-font-roboto" style="font-weight: 600; margin: 0; color: #000000;">{{$b_dropoff}}</p>
                    <p class="all-font-roboto" style="font-weight: 600; margin: 0; color: #000000;">{{$b_distance}}</p>
                  </td>
                </tr>
              </table>
              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
