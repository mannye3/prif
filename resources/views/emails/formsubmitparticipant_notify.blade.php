                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Your account request has been received and is being processed. You will receive an email on the final status within three (3) working days.</p>

                                    <p style="margin-bottom: 10px;">Kindly click <a href="{{route('userform_one_view', $app_id)}}">here</a> to view your application.</p>
