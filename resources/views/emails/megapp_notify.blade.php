                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Please note that the account opening request for {{$institution}} requires your attention.</p>
                                    <p style="margin-bottom: 10px;">Kindly <a href="{{ url('login') }}">login</a> to process the request.</p>
