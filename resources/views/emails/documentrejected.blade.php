                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    {{-- <p style="margin-bottom: 10px;">Please be informed that {{$doc_name}}  has been approved</p> --}}
                                    <p style="margin-bottom: 10px;">This is to inform you that <b>{{$doc_name}}</b> uploaded on Financial Markets Regulations & Rules Repository Portal was rejected </p>
