                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    ...
                                    <p style="margin-bottom: 10px;">Following your application to become a participant of FMDQ Depository, your account has been successfully created</p>
                                    ...
                                    <p style="color: black;"><b> Partner Name – {{$institution}} </b></p>
                                     ...
                                     <p style="color: black;"><b> Partner BPID – {{$Partner_BPID}} </b></p>
                                      ...
                                      <p style="margin-bottom: 10px;"> Should you require any clarification, please contact Depository Operations at dod@fmdqgroup.com</p>

                                      <p style="margin-bottom: 10px;"> We welcome you as a participant on our platform and look forward to a mutually rewarding relationship.</p>

                                      <p style="margin-bottom: 10px;">Thank you for choosing us.</p>
