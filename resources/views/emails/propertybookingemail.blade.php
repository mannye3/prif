                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0 30px 20px">
                                    <p style="margin-bottom: 10px;">Property Inspection Details</p>
                                   

                                   

            
                                    <p style="color: black;"><b> <a href="{{$property_link}}">Property Link</a>  </b></p>

                                    <p style="color: black;"><b>Property Name – {{$property_name}} </b></p>

                                    <p style="color: black;"><b>Customer Name – {{$name}} </b></p>

                                    <p style="color: black;"><b> Customer Email – {{$email}} </b></p>

                                    <p style="color: black;"><b> Customer Phone  – {{$phone}} </b></p>

                                    <p style="color: black;"><b> Message – {{$feedback}} </b></p>
